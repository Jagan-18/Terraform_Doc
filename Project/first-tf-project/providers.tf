...
# Desired Outcome:
-----------------
If you wish to give it a shot before looking into the detailed step-by-step and the solution, here is an overview of what the created solution should deploy:
